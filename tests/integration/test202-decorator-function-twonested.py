...
#\d{8}T\d\d:\d\d:\d\d.\d{6} BEGIN\s+main::bar\(\)\s+4:2\s*
#\d{8}T\d\d:\d\d:\d\d.\d{6} INFO\s+main::bar\(\) inner functionality\s+4:2\s*
#\d{8}T\d\d:\d\d:\d\d.\d{6} END\s+main::bar\(\)\s+4:2\s*
